package com.jumbotours.jetmasters.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jetMasters");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jetMasters");
        ...
        config.getMapConfigs().put("com.jumbotours.jetmasters.domain.*", initializeDomainMapConfig(jHipsterProperties));
