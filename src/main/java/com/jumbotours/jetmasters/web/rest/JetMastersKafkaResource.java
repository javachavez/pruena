...
@RestController
@RequestMapping("/api/jet-masters-kafka")
public class JetMastersKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JetMastersKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JetMastersKafkaResource(KafkaProperties kafkaProperties) {
